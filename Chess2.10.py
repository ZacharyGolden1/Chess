...
def moveIsLegal(app,piece,newrow,newcol,olerow,olecol):
    ...
    if isInBoard(newrow,newcol):
        ...
        if piece in kings and\
            ...
            return True
        elif piece == 'promotedPiece' and ((newrow,newcol) not in app.afterPieceRowColDiag) and\
            ...
            (newrow - olerow) == -1 and abs(olecol - newcol) == 1)):
            return True
        if piece in pawns and piece in app.whitePieces and ((newrow,newcol) not in app.afterPieceRowColDiag) and\
            newrow == 0:
            pass
