...
def generateOneFutureBoardState(app,pieces,moves,isBlackTurn):
    piecesCopy = copy.deepcopy(pieces)
    
    if moves == []:
        for move in app.allLegalAIPieceMoves:
            if move[0] != None:
    ...
    app.allLegalAIPieceMoves.pop(0)
    return piecesCopy
...
# if the depth is at a certain level return the value of the board position
# else: loop through the board and find the values of all the boards 
