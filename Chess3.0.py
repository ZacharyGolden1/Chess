...
def mouseReleased(app,event):
    ...
    app.allLegalPieceMoves = app.illegalKingMoves = []
    app.bKingCheck = app.wKingCheck = False
        ...
        if piece in kings:
            for notKing in range(len(app.allLegalPieceMoves)):
                if app.allLegalPieceMoves[notKing][0] != None and\
                    ...
                    if piece == 'wKing' and\
                       app.allLegalPieceMoves[notKing][1] == (olerow,olecol) and\
                       notKing in app.blackPieces:
                       app.wKingCheck = True
                    elif piece == 'bKing' and\
                       app.allLegalPieceMoves[notKing][1] == (olerow,olecol) and\
                       notKing in app.whitePieces:
                       app.bKingCheck = True
