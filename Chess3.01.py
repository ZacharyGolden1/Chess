...
# Chess 3.10
#### Checks and Checkmates implemented
...
def mouseReleased(app,event):
    ...
    if app.playerVsComputer and app.easyMode and (app.classicChess or app.fisherRandomChess or app.weightedOdds):
            ...
            if app.allLegalPieceMoves[notKing][0] != None and\
                ...
                if (newrow,newcol) in app.allLegalPieceMoves[notKing][1]:
                    if app.allLegalPieceMoves[notKing][0] in app.blackPieces and\
                        piece in app.whitePieces:
                        app.illegalKingMoves.append((newrow,newcol))
                    if app.allLegalPieceMoves[notKing][0] in app.whitePieces and\
                        piece in app.blackPieces:
                        app.illegalKingMoves.append((newrow,newcol))
                    if app.allLegalPieceMoves[notKing][0] in app.blackPieces:
                        app.wKingCheck = False
                    if app.allLegalPieceMoves[notKing][0] in app.whitePieces:
                        app.bKingCheck = False
        ...
        if piece in kings and\
            ...
            if app.wKingCheck and piece in app.whitePieces and not app.isBlackTurn and\
               ...
               return True
                ...
                print(app.bKingCheck,app.wKingCheck)
                print('3')
                return True
        ...
        for piece in app.blackPieces:
            for pieceNCoords in app.allLegalPieceMoves:
                ...
                if piece == pieceNCoords[0] and len(pieceNCoords[1]) <= 1:
                    tempAllLegalPieceMoves.pop(pieceIndex)
